...
This is the documentation of the residual_anomaly_detector package. 

## Short Description

Anomaly Detector on the basic assumption that high residuals of surrogate models can be indicative of anomalous behavior
